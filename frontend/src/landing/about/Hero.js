    ...
    return (
        <div className="container">
            <div className="text-center p-5 mt-5 mb-5">
                <h2 className="fw-semibold text-center fs-2">
            ...
            <div className="row p-5 mt-5 border-top text-muted">
                ...
                <div className="col-6 p-5">
                    ...
                    <p>
                        And yet, we are always up to something new every day. Catch up on the latest updates on our <a href="#" className="text-primary">blog</a> or see what the media is <a href="#" className="text-primary">saying about us</a> or learn more about our business and product <a href="#" className="text-primary">philosophies</a>.
                    </p>
                </div>
            </div>
        </div>
